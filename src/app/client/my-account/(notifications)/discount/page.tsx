  ...
  if (isLoading && page === 1) {
    return (
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-orange-500/5 to-transparent rounded-lg p-4 border border-orange-500/10">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Latest news about your discounts and promotions
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          {allNotifications.length > 0 && (
            <NormalButton onClick={() => markAsRead()}>
              <p className="text-sm text-orange-500">Mark all as read</p>
            </NormalButton>
          )}
        </div>
      </div>
        ...
        {allNotifications.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              We'll notify you when there are new discounts and promotions
            </p>
          </div>
        )}
      </div>
