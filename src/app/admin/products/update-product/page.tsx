...
import useLocalCreateProduct from "@/app/admin/products/create-product/use-local-create-product";

export default function UpdateProduct() {
    const { form, onSubmit, step, setSelectedCategory, categorySelections, brandSelections, setStep, fields, remove, attributes, append, isPending } = useLocalCreateProduct()
    return (
        <Card>
            <CardHeader>
                                                                        ...
                                                                        <Select
                                                                            ...
                                                                            onValueChange={(v) => {
                                                                                ...
                                                                                field.onChange([
                                                                                    ...others,
                                                                                    {
                                                                                        attributeCategoryId: attr.values[0]
                                                                                            .id, // id nhóm attribute
                                                                                        valueId: Number(v),
                                                                                    },
                                                                                ]);
                                                                            }}
