...
export function UpdateBrandDialog({ open, setUpdatedItem, updatedItem, setOpen }: UpdateBrandDialogProps) {
    const closeDialog = () => {
        setOpen(false)
        setUpdatedItem(undefined)
    }
    const { form, isImageLoading, isPending, onSubmit, handleCancel } = useLocalUpdateBrand(updatedItem, closeDialog)
    return (
