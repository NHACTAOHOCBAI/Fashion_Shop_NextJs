...
interface ProductTableProps {
    openDeleteDialog: (data: RowModel<Product>) => void
...
export function ProductTable({ openCreateDialog, columns, filter, isFetching, setFilter, setPagination, table, openDeleteDialog }: ProductTableProps) {
    return (
        <div>
