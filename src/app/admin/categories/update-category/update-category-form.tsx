...
export function UpdateCategoryForm({ closeDialog, updatedCategory }: UpdateCategoryFormProps) {
    const { form, isImageLoading, isPending, onSubmit, handleCancel } = useLocalUpdateCategory(updatedCategory, closeDialog)
    if (isImageLoading)
        return (
            <DialogSkeleton />
        )
