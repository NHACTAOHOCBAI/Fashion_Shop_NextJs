              ...
              <div className="space-y-3 mt-3">
                {myAddress?.map((addr) => (
                  <div
                    ...
                    className={`p-3 border rounded-xl cursor-pointer hover:border-[#FFD470] transition ${
                      selectedAddress?.id === addr.id
                        ? "border-[#FFD470] bg-[#FFF9E8]"
                        : "border-gray-200"
                    }`}
                  >
                    ...
                    <p className="text-sm text-gray-600">
                      {addr.detailAddress}, {addr.district}, {addr.province}
                    </p>
                  </div>
                ))}
              </div>
        ...
        <CardContent className="p-5 space-y-1">
          {selectedAddress ? (
            <>
              ...
              <p className="text-sm text-gray-600">
                {selectedAddress.detailAddress}, {selectedAddress.district},{" "}
