    ...
    >
      <div className="flex items-center mx-auto w-[1200px] transition-all duration-300 justify-between">
        ...
        <div className="flex items-center gap-[20px]">
          ...
          <Link
            href="/my-cart"
            className="relative p-[10px] hover:scale-[0.9] transition-all duration-300 hover:opacity-70"
          >
          ...
          {user && (
            <DropdownMenu>
              ...
              >
                ...
                <DropdownMenuGroup>
                  <DropdownMenuItem>
                    <Link className="w-full" href={"/my-account/profile"}>
                      Profile
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Link className="w-full" href={"/my-account/addresses"}>
                      Addresses
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Link className="w-full" href={"/my-account/orders"}>
                      Orders
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Link className="w-full" href={"/my-account/wishlist"}>
                      Wishlist
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Link className="w-full" href={"/my-account/notifications"}>
                      Notifications
                    </Link>
                  </DropdownMenuItem>
                </DropdownMenuGroup>
